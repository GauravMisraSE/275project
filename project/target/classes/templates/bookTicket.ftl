    ...
    <div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<td bgcolor = "#eee" width = "50" height = "100">
               ...
               <table class="table table-hover">
               <tr> 
               		<th> Base Fare </th> <td>$ {{2*bookticketctrl.getSearchDetails().passengerCount}}</td>
               </tr>
               <tr> 
               		<th> Number of Passengers </th> <td> {{bookticketctrl.getSearchDetails().passengerCount}}</td>
               </tr>
               <tr> 
               		<th> Transaction Fee </th> <td>$ 1</td>
               </tr>
               <tr> 
               	<th> Total Fare </th> <td>$ {{2*bookticketctrl.getSearchDetails().passengerCount+1}}</td>
               </tr>
               </table>
               </center>
            </td>
