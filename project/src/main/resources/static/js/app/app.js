...
app.constant('urls', {
    ...
    USER_SERVICE_API : 'http://localhost:0.0.0.0/cusr/api/user/',
    TRAIN_SEARCH_API : 'http://localhost:0.0.0.0/cusr/api/search',
    TICKET_SEARCH_API : 'http://localhost:0.0.0.0/cusr/api/ticket/',
    TICKET_AVAIL_API: 'http://localhost:0.0.0.0/cusr/api/availability/',
    	TRAIN_CANCEL_API: 'http://localhost:0.0.0.0/cusr/api/trainCancellation/',
    	TICKET_CANCEL_API : 'http://localhost:0.0.0.0/cusr/api/cancel/'
